            ...
            if ep < 5 or ep % 10 == 0 or ep > 250:
                ...
                if len(self.test_loader) > 0:
                    ...
                    for it, [rgb_, sar_, rgb_warp_, sar_warp_, gt_tp_, gt_disp_] in p_test_bar:
                        ...
                        with torch.no_grad():
                            image_sar_reg, cor_rmse, disp_rmse, sar_re, sar_re_masked, valid_ratio, cmr_1, cmr_3, cmr_5, valid_mask = self.model.test_forward(image_rgb_, image_sar_, image_rgb_warp_, image_sar_warp_, gt_tp_, gt_disp_)
